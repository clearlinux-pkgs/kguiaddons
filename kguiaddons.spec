...
Source0  : https://download.kde.org/stable/frameworks/6.4/kguiaddons-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kguiaddons-6.4.0.tar.xz.sig
...
%setup -q -n kguiaddons-6.4.0
cd %{_builddir}/kguiaddons-6.4.0
pushd ..
cp -a kguiaddons-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720807092
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6GuiAddons.so.6.4.0
/usr/lib64/libKF6GuiAddons.so.6
/usr/lib64/libKF6GuiAddons.so.6.4.0
