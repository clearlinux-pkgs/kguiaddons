...
Source0  : https://download.kde.org/stable/frameworks/6.13/kguiaddons-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kguiaddons-6.13.0.tar.xz.sig
...
%setup -q -n kguiaddons-6.13.0
cd %{_builddir}/kguiaddons-6.13.0
pushd ..
cp -a kguiaddons-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744642134
mkdir -p clr-build
pushd clr-build
